...
- **机器人突袭** — 随机强度进攻，按玩家强度加权命中，自动结算并发送 @ 通知
...
4. **防守护盾缩放** — 被攻击获得护盾时长按基地强度加权缩短，越强越短，最低 1 小时
5. **机器人攻击判定** — 机器人可攻击任何玩家；若目标有护盾则本次攻击失败，结算全 0，仍记录日志并 @ 通知
