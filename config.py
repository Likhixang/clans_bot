...
BUILDINGS = {
    ...
    "guard_post": {
        "name": "哨塔", "emoji": "🗼",
        "resource": "gold",
        "max_level": 12, "th_required": 6,
        "costs": [120000, 220000, 360000, 560000, 820000, 1160000, 1600000, 2160000, 2840000, 3660000, 4620000, 5750000],
        "defense": [220, 420, 700, 1050, 1480, 2010, 2640, 3380, 4230, 5200, 6290, 7500],
        "desc": "中程警戒防御塔，可提升基地外围压制力",
    },
    "builder_hut": {
        "name": "工人小屋", "emoji": "🛖",
        "resource": "gold",
        "max_level": 10, "th_required": 8,
        "costs": [160000, 280000, 450000, 690000, 1020000, 1450000, 2010000, 2700000, 3520000, 4500000],
        "desc": "后勤建筑，当前版本用于基地发展进度",
    },
    "laboratory": {
        "name": "实验室", "emoji": "🔬",
        "resource": "elixir",
        "max_level": 10, "th_required": 9,
        "costs": [180000, 310000, 500000, 760000, 1120000, 1590000, 2200000, 2950000, 3850000, 4900000],
        "desc": "科技建筑，当前版本用于基地发展进度",
    },
    "spell_factory": {
        "name": "法术工厂", "emoji": "🧿",
        "resource": "elixir",
        "max_level": 10, "th_required": 10,
        "costs": [220000, 360000, 570000, 850000, 1240000, 1740000, 2390000, 3200000, 4170000, 5300000],
        "desc": "法术建筑，当前版本用于基地发展进度",
    },
    "workshop": {
        "name": "攻城工坊", "emoji": "⚙️",
        "resource": "gold",
        "max_level": 10, "th_required": 11,
        "costs": [250000, 410000, 640000, 930000, 1330000, 1850000, 2510000, 3330000, 4320000, 5500000],
        "desc": "器械建筑，当前版本用于基地发展进度",
    },
    "hero_altar": {
        "name": "英雄祭坛", "emoji": "🗿",
        "resource": "elixir",
        "max_level": 10, "th_required": 12,
        "costs": [290000, 470000, 710000, 1030000, 1450000, 2000000, 2690000, 3530000, 4560000, 5800000],
        "desc": "英雄建筑，当前版本用于基地发展进度",
    },
    "clan_castle": {
        "name": "部落城堡", "emoji": "🏯",
        "resource": "gold",
        "max_level": 10, "th_required": 13,
        "costs": [340000, 540000, 800000, 1140000, 1590000, 2180000, 2920000, 3830000, 4930000, 6250000],
        "desc": "部落地标，当前版本用于基地发展进度",
    },
    "wall": {
        "name": "城墙", "emoji": "🧱",
        "resource": "gold",
...
CLAN_WAR_REWARD_WIN = 120
CLAN_WAR_REWARD_LOSE = 60
CLAN_WAR_REWARD_DRAW = 90
